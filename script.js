...
function hitung() {
  ...
  setTimeout(() => {
    ...
    let angsuran = (pokokUtang + pokokUtang * bunga) / jangka;
    let totalBayar = angsuran * jangka;
    let totalBunga = totalBayar - pokokUtang;
    ...
    let hasilHTML = `
      <div style="text-align: left;">
        ...
        <div style="background: rgba(255, 255, 255, 0.7); padding: 15px; border-radius: 10px; margin-top: 10px;">
          ...
          <p style="margin: 8px 0;">• <strong>Bunga:</strong> ${(bunga*100).toFixed(1)}% per tahun</p>
    ...
    <body>
      ...
      <div class="result">
        ...
        <div class="result-item">
          ...
          <span>${hasilData.bunga.toFixed(1)}% per tahun</span>
        </div>
        <div class="result-item">
...
║  • Bunga                 : ${hasilData.bunga.toFixed(1)}% per tahun${''.padEnd(31)}║
